...
@FindBy(linkText = "[text()='Kursuna Giriş']")
    ...
    @FindBy(xpath = "//div[@class='t-sociallinks']/ul/li")
    public WebElement facebook;

    @FindBy(xpath = "//div[@class='t-sociallinks']/ul/li/a")
    public WebElement instagram;

    @FindBy(xpath = "//div[@class='t-sociallinks']/ul/li")
    public WebElement twiter;

    @FindBy(css = "[class='t-sociallinks__item t-sociallinks__item_linkedin']")
